...
//import course.examples.Fragments.DynamicLayout.ChicagoPlacesFragment.ListSelectionListener;
import layout.ChicagoPlacesFragment.ListSelectionListener;

//Several Activity lifecycle methods are instrumented to emit LogCat output
//so you can follow this class' lifecycle
public class IndianaPolisViewerActivity extends Activity implements
    ...
    private final ChicagoPlaces2Fragment mQuoteFragment = new ChicagoPlaces2Fragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get references to the TitleFragment and to the ChicagoPlaces2Fragment
    ...
    // Called when the user selects an item in the ChicagoPlacesFragment
    @Override
    public void onListSelection(int index) {
        ...
        if (mQuoteFragment.getShownIndex() != index) {
            ...
            mQuoteFragment.showWebViewAtIndex(index);
