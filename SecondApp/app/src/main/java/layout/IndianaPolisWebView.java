 ...
 */
public class IndianaPolisWebView extends Fragment {
    ...
    /*
    this will be called first when a frament is created
     */
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String value = b.getString("websiteUrl");
